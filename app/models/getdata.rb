class Getdata
    ...
    def self.url_choice(choice)
        case choice
        when "Publication"
            entry = @@prompt.ask("Enter publication:")
            formatted = entry.split(" ").join("-")
            "https://newsapi.org/v2/top-headlines?sources=#{formatted}&apiKey=673f3f5241b64daa84e1bd2f1e46e704"

        when "US Headlines"
            "https://newsapi.org/v2/top-headlines?country=us&sortBy=popularity&apiKey=673f3f5241b64daa84e1bd2f1e46e704"

        when "Business Headlines"
            "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=673f3f5241b64daa84e1bd2f1e46e704"

        when "Tech News"
            "https://newsapi.org/v2/everything?q=tech&language=en&sortBy=popluarity&sortBy=publishedAt&apiKey=673f3f5241b64daa84e1bd2f1e46e704"
        end
    end
end
